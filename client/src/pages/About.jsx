    ...
    <>
      <div className="px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-lg sm:text-xl lg:text-xl text-center mb-8 lg:px-32 lg:text-justify">
          Block Crowdfunding is a Blockchain based Crowd Funding platform, designed to
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-4">
          Block Crowdfunding Innovation
        </h2>

        <p className="text-lg sm:text-xl lg:text-lg text-center mb-8">
          Block Crowdfunding aims to redefine the funding landscape, providing a
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center mb-8">
            ...
            <Card>
              <CardBody>
                <p className="text-lg lg:text-normal text-center">
                  Products on Block Crowdfunding are unique. They
          ...
          <div className="sm:w-1/3 px-4 mb-4">
            <Card>
              <CardBody>
                <p className="text-lg lg:text-normal text-center">
                  Block Crowdfunding look for things that could be useful in my everyday
          ...
          <div className="sm:w-1/3 px-4 mb-4">
            <Card>
              <CardBody>
                <p className="text-lg lg:text-normal text-center">
                  Block Crowdfunding allows you to connect your creations with a
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl font-bold text-white">
                Find it first on Block Crowdfunding
              </h1>
            </div>
          </div>
        </div>
        ...
        <p className="text-lg sm:text-xl lg:text-lg lg:text-justify lg:px-32 text-center mb-8">
          Block Crowdfunding's support for creative work goes beyond our platform. We
        ...
        <p className="text-lg sm:text-xl lg:text-lg text-center lg:text-justify lg:px-32">
          ...
          spend our time designing and building Block Crowdfunding, forging community
        ...
        <div className="flex flex-col items-center pt-20 sm:pt-10 md:pt-20 lg:pt-24 xl:pt-32">
          <button
            className="text-white px-6 py-3 rounded-[10px] bg-[#ff0000] mb-14"
