      ...
      <div className="flex flex-col items-center py-10 px-4 min-h-screen">
        ...
        <div className="bg-white dark:bg-[#1c1c24] shadow-md rounded-lg p-8 max-w-5xl w-full mx-auto">
          ...
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            At Crowdfunding, trust and safety are our top priorities. We ensure a secure and transparent platform for both campaigners and backers. Here’s how we protect our community:
          </p>
