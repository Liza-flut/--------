      ...
      <div className="flex flex-col items-center py-10 px-4 min-h-screen">
        ...
        <div className="bg-white dark:bg-[#1c1c24] shadow-md rounded-lg p-8 max-w-5xl w-full mx-auto">
          ...
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            Supporting a crowdfunding campaign can be a rewarding experience. Here's how you can evaluate and back campaigns on Crowdfunding Fund:
          </p>

          <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">1. Explore Campaigns</h3>
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            Browse through various campaigns on the Crowdfunding Fund platform. You can use filters to find campaigns that match your interests. Each campaign has a detailed page with information about the project, funding goals, timeline, and updates from the campaign creator.
          </p>
          ...
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            After backing a campaign, you can manage your contributions through your Crowdfunding Fund profile. You can track the progress of the campaigns you've supported, communicate with the campaign creators, and stay updated with their latest posts and developments.
          </p>

          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Understanding Crowdfunding Fund Policies</h2>
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            Crowdfunding Fund is committed to maintaining a secure and transparent platform. Here are some key policies to be aware of as a backer:
          </p>
          ...
          <p className="mb-4 text-gray-800 dark:text-gray-200">
            By using Crowdfunding Fund, you agree to our Terms of Service. These terms outline your rights and responsibilities as a user, including acceptable use policies, intellectual property rights, and dispute resolution procedures.
          </p>
