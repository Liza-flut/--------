//сравнение с другой платформой, но я не знаю где это находится
    ...
    <>
      ...
      <div className="text-center my-8 max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold pb-3 text-[#8c6dfd]">
          Evaluating Block Crowdfunding vs. Traditional Crowdfunding Platforms?{" "}
        </h2>
        ...
        <p className="text-justify text-lg pb-8">
          As you weigh your options, consider this: Block Crowdfunding is the leading
        ...
        <p className="text-justify text-lg pb-8">
          ...
          social good, Block Crowdfunding will help you successfully launch your
      ...
      <div className="flex flex-col md:flex-row justify-center items-center my-4 max-w-5xl mx-auto">
        ...
        <div className="text-center md:text-left md:pl-8">
          ...
          <p className="text-3xl font-bold pb-3">
            Block Crowdfunding provides expert security features like immutable record,
      ...
      <div className="text-center my-8 max-w-3xl mx-auto">
        <p className="text-justify text-lg pb-8">
          Backer confidence is a critical component of the Block Crowdfunding platform,
          ...
          combining these robust features, Block Crowdfunding enhances backer
      ...
      <div className="text-center my-8 max-w-3xl mx-auto">
        <p className="text-justify text-lg pb-8">
          Block Crowdfunding embodies flexibility and global reach, granting creators
          ...
          pool of backers and a borderless approach to fundraising, Block Crowdfunding
      ...
      <div className="text-center my-8 max-w-3xl mx-auto">
        <p className="text-justify text-lg pb-8">
          ...
          interests of backers and project creators alike. Block Crowdfunding
      ...
      <div className="text-center my-8 max-w-3xl mx-auto">
        <p className="text-justify text-lg pb-8">
          One of the standout advantages of Block Crowdfunding is its ability to
          ...
          Crowdfunding Fund streamlines this process by using smart contracts to
          ...
          these intermediary costs, Crowdfunding Fund maximizes the efficiency and
